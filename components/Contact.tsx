        ...
        <div className="bg-indigo-600 rounded-[3rem] overflow-hidden relative shadow-2xl">
          ...
          <div className="relative z-10 px-8 py-20 md:p-20 flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="max-w-2xl text-center lg:text-left">
              ...
              <p className="text-indigo-50 text-xl md:text-2xl leading-relaxed font-medium">
            ...
            <div className="flex flex-col gap-4 w-full md:w-80 shrink-0">
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                aria-label="Contact S M Fajla Rabbi on WhatsApp"
                className="bg-white text-indigo-600 px-8 py-5 rounded-2xl text-lg font-bold flex items-center justify-center gap-3 hover:bg-slate-50 transition-all shadow-xl active:scale-95 w-full"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                aria-label="Connect with S M Fajla Rabbi on LinkedIn"
                className="bg-indigo-700 text-white border border-indigo-500 px-8 py-5 rounded-2xl text-lg font-bold flex items-center justify-center gap-3 hover:bg-indigo-800 transition-all shadow-xl active:scale-95 w-full"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                LinkedIn Profile
              </a>
              <a 
                href="mailto:istiakrobbi25@gmail.com" 
                aria-label="Send an Email to S M Fajla Rabbi"
                className="bg-indigo-800/40 text-white border border-indigo-400/30 px-8 py-5 rounded-2xl text-lg font-bold flex items-center justify-center gap-3 hover:bg-indigo-800/60 transition-all shadow-xl active:scale-95 w-full"
              >
        ...
        <div className="mt-20 pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col md:flex-row items-center gap-4">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-indigo-600 rounded flex items-center justify-center text-white font-bold">FR</div>
