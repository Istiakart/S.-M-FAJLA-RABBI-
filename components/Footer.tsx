        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-slate-400 leading-relaxed text-sm">
              Data-driven growth specialist focused on ROI. Successfully generated <span className="text-blue-400 font-bold">142 leads</span> at an optimized cost of <span className="text-blue-400 font-bold">BDT 8.20 per message</span>.
            </p>
