        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-extrabold tracking-tight leading-none">
                  S M FAJLA <span className="text-indigo-500">RABBI</span>
                </span>
            ...
            <p className="text-slate-400 leading-relaxed text-sm">
              Data-driven growth specialist focused on ROI. Successfully generated <span className="text-indigo-400 font-bold">142 leads</span> at an optimized cost of <span className="text-indigo-400 font-bold">BDT 8.20 per message</span>.
            </p>
            <div className="flex gap-4">
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                aria-label="Visit S M Fajla Rabbi's LinkedIn profile"
                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-indigo-600 transition-colors group"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                aria-label="Chat with S M Fajla Rabbi on WhatsApp"
                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-indigo-600 transition-colors group"
              >
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 font-medium text-sm">
              ...
              <li><a href="#ai-lab" className="hover:text-indigo-400 transition-colors">AI Lab</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <button 
                ...
                className="mt-4 flex items-center gap-2 text-xs font-bold text-indigo-400 hover:text-indigo-300 transition-colors group uppercase tracking-widest"
              >
                BACK TO TOP
