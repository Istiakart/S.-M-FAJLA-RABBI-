 ...
 * These are high-ROI pillars used to scale brands, based on Skill Room Bangladesh IT methodologies.
 */
  ...
  return (
    <section id="services" className="py-24 bg-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {SERVICES.map((service, index) => (
            <div 
              ...
              className="group bg-white p-10 rounded-3xl shadow-sm border border-slate-100 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 hover:bg-gradient-to-br hover:from-white hover:to-indigo-50/50 animate-fade-in-up"
            >
              <div className="w-14 h-14 bg-indigo-50 text-indigo-600 rounded-2xl flex items-center justify-center mb-8 transition-all duration-300 group-hover:bg-indigo-600 group-hover:text-white group-hover:rotate-3 group-hover:scale-110 shadow-sm">
                {/* Robust icon rendering with Zap as fallback */}
                {service.icon || <Zap className="w-6 h-6" />}
              </div>
              
              <h4 className="text-2xl font-bold text-slate-900 mb-4 transition-colors group-hover:text-indigo-600">
                {service.title}
              </h4>
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 text-indigo-600 font-bold text-sm uppercase tracking-wider group-hover:gap-4 transition-all"
              >
                Explore Solution 
        ...
        {/* Global Strategy CTA */}
        <div className="mt-20 p-8 md:p-12 rounded-[2.5rem] bg-indigo-900 text-white relative overflow-hidden shadow-2xl animate-fade-in">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <a 
              ...
              className="bg-white text-indigo-600 px-8 py-4 rounded-2xl font-bold hover:bg-indigo-50 transition-all shadow-xl shadow-indigo-950/20 active:scale-95 whitespace-nowrap text-center flex items-center justify-center gap-2"
            >
